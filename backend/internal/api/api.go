...
func (h *Handler) Routes() http.Handler {
	...
	mux.HandleFunc("GET /trusted-ips", h.listTrusted)
	mux.HandleFunc("POST /trusted-ips", h.createTrusted)
	mux.HandleFunc("DELETE /trusted-ips/{id}", h.deleteTrusted)
	...
	mux.HandleFunc("GET /config-snapshots/{id}", h.getSnapshot)
	mux.HandleFunc("POST /config-snapshots/{id}/rollback", h.rollback)
	mux.HandleFunc("GET /config/export", h.exportConfig)
